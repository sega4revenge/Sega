package com.sega.vimarket.view;
...
import com.sega.vimarket.enums.Duration;
import com.sega.vimarket.enums.Style;
...
public interface IBuilder {
     ...
     * @return this
     */
    MaterialStyledDialog.Builder setCustomView(View customView, int left, int top, int right,
                                               int bottom);
     ...
     * @return this
     */
    MaterialStyledDialog.Builder setPositive(String text,
     ...
     * @return this
     */
    MaterialStyledDialog.Builder setNeutral(String text,
                                            MaterialDialog.SingleButtonCallback callback);
