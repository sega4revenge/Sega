...
public class  GPSTracker extends Service implements LocationListener {
    ...
    public static LatLng mLastestLocation;
    ...
    public void onCreate() {
        super.onCreate();
        mLastestLocation = new LatLng(getLocation().getLatitude(), getLocation().getLongitude());
    ...
    public void onLocationChanged(Location location) {
        mLastestLocation = new LatLng(location.getLatitude(), location.getLongitude());
    }
