...
import com.sega.vimarket.fragment.ProductSoldFragmentPersonal;
import com.sega.vimarket.fragment.ProductSoldFragmentProfile;

import butterknife.ButterKnife;

/**
 * Created by Sega on 20/01/2017.
 */

public class PersonalProductSold extends CActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ProductSoldFragmentPersonal fragment = new ProductSoldFragmentPersonal();
