...
import com.sega.vimarket.fragment.ProductFragmentPersonal;
...
public class PersonalProduct extends CActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ProductFragmentPersonal fragment = new ProductFragmentPersonal();
